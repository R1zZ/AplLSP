...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RadioButtonGroup = function (_Component) {
	  ...
	  function RadioButtonGroup(props) {
	    ...
	    _this.state = { optionsVal: '' };
	    return _this;
	  }

	  _createClass(RadioButtonGroup, [{
	    key: 'handleQueryOpChange',
	    value: function handleQueryOpChange(e) {
	      this.setState({
	    ...
	    value: function render() {
	      ...
	      var renderItems = function renderItems(item) {
	        return _react2.default.createElement(
	          'label',
	          { key: item.value,
	            className: 'btn-item radio-button-item ' + (_this2.state.optionsVal === item.value ? 'checked' : 'not-checked') },
	          _react2.default.createElement('input', { type: 'radio', name: 'options', value: item.value,
	            checked: _this2.state.optionsVal === item.value,
	            onChange: function onChange(e) {
	              return _this2.handleQueryOpChange(e);
	            }, id: item.value }),
	          _react2.default.createElement('span', { className: 'radio-dot' }),
	          _react2.default.createElement(
	            'span',
	            { className: 'radio-button-item-word' },
	            item.text
	          )
	        );
	      };
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        this.props.listOfItems.map(function (item) {
	...
	RadioButtonGroup.propTypes = {
	  listOfItems: _react.PropTypes.array,
	  selectedItemCallback: _react.PropTypes.func.isRequired
	};
